...
3. **传输通道抽象 (Transport Abstraction)**：内置原生 FTP/SFTP 第三方服务可视化通道支持，并适配网闸摆渡、NFS/SMB 共享目录、HTTP 代理等多种传输介质。
