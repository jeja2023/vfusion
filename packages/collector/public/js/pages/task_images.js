    ...
    return `
      <div style="background:#ffffff; border:1px solid #e2e8f0; border-radius:10px; overflow:hidden; display:flex; flex-direction:column; box-shadow:0 2px 5px rgba(0,0,0,0.04); transition:transform 0.15s ease, box-shadow 0.15s ease;">
        ...
        <div style="position:relative; width:100%; height:185px; background:#0f172a; overflow:hidden; cursor:pointer;" onclick="viewGalleryImageLightbox('${escapeJsString(img.id)}')">
          <img src="${escapeHtml(img.url)}" style="width:100%; height:100%; object-fit:cover; transition:transform 0.3s ease;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
